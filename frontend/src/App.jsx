  ...
  return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 flex items-center justify-center p-4">
            <div className="w-full max-w-2xl backdrop-blur-md bg-white/30 border border-white/50 shadow-xl rounded-3xl p-8 transition-all duration-300">
                ...
                <div className='mb-10 justify-center flex flex-col'>
                    <ol>
          ...
          <button
            onClick={uploadFile}
            className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 px-6 rounded-xl shadow-lg transition-all duration-300"
          >
            Upload PDF
          </button>
        </div>
